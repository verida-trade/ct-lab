...
Treine uma LSTM com PyTorch via `modelo_custom`.
...
> O `uv` baixa torch na primeira execução. As deps viajam no `ModeloFitado` para o `aplicar_modelo` reconstruir o ambiente.
